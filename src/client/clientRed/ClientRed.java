...
public class ClientRed extends BorderPane {
    ...
    private boolean initFxml = false;
    ...
    private AnimationTimer animationTimer = new AnimationTimer() {
        ...
        public void handle(long now) {
            try {
                ...
                else if (game.getGagnant() != Game.DEFAULT) {
    ...
    public ClientRed() throws Exception{
